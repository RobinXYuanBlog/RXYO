...
//                    Log.i("Alex", "准备存储到相册");
                    try {
                        ...
                        albumUrl = BitmapUtils.insertImage(this, cr, file, true);//返回值为要发送图片的url
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    ...
                    intent.setClass(SelectPhotoActivity.this, ImageProcessingActivity.class);
...
//                    startActivity(intent);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_cancel:
                finish();
//                overridePendingTransition(R.anim.out_from_center_to_left, R.anim.in_from_right_to_center);
                break;
            case R.id.tv_done:
                if(selectedPhotoList == null)selectedPhotoList = new ArrayList<>(1);
