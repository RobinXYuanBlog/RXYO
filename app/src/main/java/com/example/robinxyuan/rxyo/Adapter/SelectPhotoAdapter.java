...
//        Log.i("Alex","要显示的position是"+position);
        ...
        if (position == 0) {//第一个位置显示一个小相机
            imageLoader.setAsyncBitmapFromSD(null, viewHolder.iv_photo, 0, false, false, false);//防止回调覆盖了imageView原来的bitmap
            ...
            imageLoader.setAsyncBitmapFromSD(filePath, viewHolder.iv_photo, screenWidth / 3, false, true, true);
